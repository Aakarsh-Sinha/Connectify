...
function Sidebar({setActive}) {
    ...
    return (
    <>
        <div className="p-[2vw] h-[90vh] w-[30vw] flex flex-col fixed">
            ...
            <Sidebarcomp title={"Send Request"} icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-arrow-up-fill" viewBox="0 0 16 16">
            ...
            <Sidebarcomp title={"My Profile"} icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
