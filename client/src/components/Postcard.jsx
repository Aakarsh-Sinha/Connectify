...
function Postcard({post}){
    return(
        <div className="flex flex-col border-t border-gray-500">
           <div className="p-[1vw] font-bold text-xl">
           ...
           <div className="flex flex-row p-[0.5vw] justify-around">
                ...
                <div><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-dots-fill" viewBox="0 0 16 16">
